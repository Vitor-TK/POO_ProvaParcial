...
public class Main {
		...
		do {
			...
			case "1":
				if (indexList >= lista.length) {
					System.out.println("Número máximo de reservas atingido! O sr(a) vai ser colocado na lista de espera");
	...
	public static boolean checar(String string) {
	    ...
	    try {
	        ...
	        System.out.println("Comando digitado não é uma opção numérica.");
	    } 
	    return false;
	}
